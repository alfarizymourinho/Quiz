...
function deleteQuestion(id) {
  router.on('before', () => {
    return confirm('Apakah kamu yakin ingin menghapus pertanyaan ini?')
  })
            ...
            <table class="table">
              ...
              <tbody>
                <tr v-for="(answer, index) in newAnswers">
                  ...
                  <td>
                    <input type="text" v-model="answer.answer" class="form-control" id="exampleInputEmail1"
                      aria-describedby="emailHelp">
                  </td>
                  <td>
                    <input :checked="answer.correct_answer === 1" class="form-check-input" :value="answer.id"
                      @change="handleRadioToggle(answer.id)" type="radio">
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <table class="table">
            ...
            <tbody>
              <tr v-for="(answer, index) in answers">
                ...
                <td>
                  <input :checked="answer.correct_answer === 1" class="form-check-input" :value="answer.id"
                    @change="handleRadioChange(answer.id)" type="radio">
                </td>
              </tr>
            </tbody>
          </table>
